...
import com.mycompany.game.ImageLoader;
import com.mycompany.game.SpriteSheet;
...
public class Assets {
    ...
    public static void init() {
        ...
        player_up[0] = playerSheet.crop(0, pHeight * 3, pWidth, pHeight);
        player_up[1] = playerSheet.crop(pWidth, pHeight * 3, pWidth, pHeight);
        player_up[2] = playerSheet.crop(pWidth * 2, pHeight * 3, pWidth, pHeight);       
        ...
        player_right[0] = playerSheet.crop(0, pHeight * 2, pWidth, pHeight);
        player_right[1] = playerSheet.crop(pWidth, pHeight * 2, pWidth, pHeight);
        player_right[2] = playerSheet.crop(pWidth * 2, pHeight * 2, pWidth, pHeight);
